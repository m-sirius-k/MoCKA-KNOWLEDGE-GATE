...
三つ目は、研究知識が循環する仕組みである。研究の実行、検証、制度化、再利用という流れが循環し、MoCKA Insight System 全体が積み上がる研究文明として成長していく。この循環の中で Knowledge Gate は制度的記憶の役割を担い、研究の再現性と継続性を支えている。
   ...
   入力（Execution Logs、Reasoning Traces、Validation Results）  
   中央（Context Structuring、Institutionalization、Reuse Tags）  
   出力（Future Research、Governance Decisions、Civilization Layer）  
   矢印は左から中央、中央から右、右から中央へのフィードバック。

   MoCKA Core、Knowledge Gate、Transparency Layer、External Brain、Civilization Layer の縦レイヤー構造。

   Execution、Verification、Institutionalization、Reuse の循環構造。
...
### Knowledge Gate フロー図
![Knowledge Gate Flow](docs/images/knowledge_gate_flow.svg)

### MoCKA Insight System 全体レイヤー図
![MoCKA System Layers](docs/images/mocka_system_layers.svg)

### Research Knowledge Flow 図
![Research Knowledge Cycle](docs/images/research_knowledge_cycle.svg)
### Knowledge Gate フロー図（更新版）
![Knowledge Gate Flow](docs/images/knowledge_gate_flow.svg)
### Knowledge Gate フロー図（線強化・ビジュアル改善版）
![Knowledge Gate Flow](docs/images/knowledge_gate_flow.svg)
### Knowledge Gate フロー図（線強化・ビジュアル改善版）
![Knowledge Gate Flow](docs/images/knowledge_gate_flow.svg)
### Knowledge Gate フロー図（枠線色付き・視認性向上版）
![Knowledge Gate Flow](docs/images/knowledge_gate_flow.svg)
