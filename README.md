...
| System Layer | Description | Repository |
|---|---|---|
| MoCKA Core | Research execution engine | 🟦 [open｜MoCKA Core](https://github.com/m-sirius-k/MoCKA) |
| Knowledge Gate | Institutional memory infrastructure | 🟩 [open｜Knowledge Gate](https://github.com/m-sirius-k/MoCKA-KNOWLEDGE-GATE) |
