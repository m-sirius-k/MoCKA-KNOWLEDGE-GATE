...
![Knowledge Preservation Flow](docs/images/knowledge_preservation_flow.svg)
...
Knowledge Gate preserves multiple types of research artifacts.
...
MoCKA Knowledge Gate stores structured institutional memory.
...
Knowledge Gate は複数の種類の研究成果を保存します。
...
MoCKA Knowledge Gate は MoCKA Insight System の記憶基盤として機能します。
